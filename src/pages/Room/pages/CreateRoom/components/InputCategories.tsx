...
export const InputCategories: FunctionComponent<InputCategoriesProps> = ( { inputList, setInputList } ) => {
            ...
            inputList.map((x, i) => {
                return (
                    ...
                    <input
                      ...
                      onChange={(ev: React.ChangeEvent<HTMLInputElement>) => handleInputChange(ev, i)}
                    />
                      {inputList.length !== 1 && 
